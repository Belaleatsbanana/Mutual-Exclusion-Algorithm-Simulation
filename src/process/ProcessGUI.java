    ...
    public class ProcessGUI extends javax.swing.JFrame {
         ...
         */
        public ProcessGUI(String processId) {
        ...
        private void handleReserve() {
            ...
            try {
                ...
                Process processThread = new Process(processId, "localhost", 5000, resource,
                        response -> JOptionPane.showMessageDialog(this, response));
        ...
        public static void main(String[] args) {
            ...
            if (args.length == 0) {
                System.err.println("Usage: java ProcessGUI <processId>");
                System.exit(1);
            }
            ...
            java.awt.EventQueue.invokeLater(() -> {
                new ProcessGUI(processId).setVisible(true); // Pass processId to the constructor
            });
        }
